...
or using an holdout dataset.
The holdout dataset of Grobid-quantities is composed by the following examples:

- Quantities ML: 10 articles
- Units ML: [UNISCOR dataset](https://grobid-quantities.readthedocs.io/en/latest/references.html#other) with around 1600
  examples
...
Units were evaluated using UNISCOR dataset. For more information check the section `uniscor`{.interpreted-text role="
ref"}.
...
| Labels          | CRF   |       |       | BidLSTM_CRF_FEATURES |       |       |
|-----------------|-------|-------|-------|----------------------|-------|-------|
| Metrics         | P     | R     | F1    | P                    | R     | F1    |
