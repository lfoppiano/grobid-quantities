...
The latest released version of grobid-quantities is [0.8.2](https://github.com/kermitt2/grobid-quantities/releases/tag/v0.8.2). 
The current development version is 0.8.3-SNAPSHOT.
