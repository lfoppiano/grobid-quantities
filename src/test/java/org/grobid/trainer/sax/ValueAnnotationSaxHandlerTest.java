...
public class ValueAnnotationSaxHandlerTest {
    ...
    public void testParsing_1_shouldWork() throws Exception {
        ...
        assertThat(valueLabeled.getLabels(), hasSize(4));
        ...
        assertThat(valueLabeled.getLabels().get(2).getLeft(), is("10"));
...
//        assertThat(valueLabeled.getLabels().get(3).getRight(), is("<base>"));
        assertThat(valueLabeled.getLabels().get(3).getLeft(), is("3"));
        assertThat(valueLabeled.getLabels().get(3).getRight(), is("I-<pow>"));
    }
    ...
    public void testParsing_3_shouldWork() throws Exception {
        ...
        assertThat(valueLabeled.getLabels(), hasSize(1));
        assertThat(valueLabeled.getLabels().get(0).getLeft(), is("twentytwo"));
...
//        assertThat(valueLabeled.getLabels().get(3).getLeft(), is("0"));
//        assertThat(valueLabeled.getLabels().get(3).getRight(), is("<base>"));
        assertThat(valueLabeled.getLabels().get(3).getLeft(), is("10"));
        assertThat(valueLabeled.getLabels().get(3).getRight(), is("I-<pow>"));
