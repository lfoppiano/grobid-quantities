 ...
 */
public class FeaturesVectorQuantifiedObjects {
    ...
    public FeaturesVectorQuantifiedObjects() {
    }
     ...
     */
    public static FeaturesVectorQuantifiedObjects addFeatures(String word, String label, boolean measure) {
        FeatureFactory featureFactory = FeatureFactory.getInstance();

        FeaturesVectorQuantifiedObjects featuresVector = new FeaturesVectorQuantifiedObjects();
        ...
        featuresVector.isMeasure = measure;
