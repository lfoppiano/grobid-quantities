 ...
 *
 */
public class QuantitiesRestProcessGeneric {
	
	/**
	 * The class Logger.
	 */
	private static final Logger LOGGER = LoggerFactory
			.getLogger(QuantitiesRestProcessGeneric.class);
	...
	public static Response isAlive() {
		...
		try {
			...
			try {
				...
				LOGGER.error("Grobid Keyphrase extraction service is not alive, because of: ", e);
